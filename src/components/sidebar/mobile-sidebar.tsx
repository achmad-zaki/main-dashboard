...
export default function MobileSidebarComponent() {
    ...
    return (
        <aside className={`fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-800 transition-all duration-300 ${sidebar ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-64"} md:hidden`}>
