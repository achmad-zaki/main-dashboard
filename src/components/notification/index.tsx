...
export default function NotificationComponent() {
    return (
        <Menu as="li" className="relative">
            <Menu.Button className="relative align-middle outline-ring-purple rounded-sm">
            ...
            >
                <Menu.Items as="ul" className="absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-white border border-gray-100 rounded-md shadow-md dark:text-gray-300 dark:border-gray-700 dark:bg-gray-700">
                    <Menu.Item as="li" className="flex">
                        <Link href="/" className="inline-flex items-center justify-between w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200">
                            <span>Message</span>
                        </Link>
                    </Menu.Item>
                </Menu.Items>
